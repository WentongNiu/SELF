...
class RobertaEmbeddings(nn.Module):
   ...
   def forward(
       ...
       if inputs_embeds is None:
           inputs_embeds = self.word_embeddings(input_ids.to('cuda:1'))
       ...
       entity_mask = entity_mask.to('cuda:1').unsqueeze(-1)
       ...
       if self.training:
           ...
           for k in range(k_size):
               random_weight = torch.rand(entity_mask.size()[0], 1, 1).to('cuda:1') * mul
